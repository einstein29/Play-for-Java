...
public class Product {
	...
	/* Ah hoc validation on page-129. 
	 * You specify which field paramete that you want it to be validated here.
	 * Play will call this method automatically just before passing this object
	 * to the controller class. 
	 */
	public String validate() {
		final String pattern = "^[0-9]{13}$";
		Pattern p = Pattern.compile(pattern);
		Matcher m = p.matcher(ean);
		return m.matches()? null : "Invalid ean number";
	}
}
